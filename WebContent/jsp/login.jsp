...
<body>
	...
	<div class="container"  style="height:460px;background:#FF2C4C url('${pageContext.request.contextPath}/img/loginbg.jpg') no-repeat;">
		<div class="row"> 
			<div class="col-md-7">
			...
			<div class="col-md-5">
				...
				<font>会员登录</font>USER LOGIN <span><font style="color:red;">${msg}</font></span>
				...
				<form class="form-horizontal" action="${pageContext.request.contextPath}/userServlet?method=login" method="POST">
					 ...
					 <div class="form-group">
					    ...
					    <div class="col-sm-6">
					      <input type="text" class="form-control" name="username" id="username" placeholder="请输入用户名" value="${cookie.usernameCookie.value}">
					    </div>
					  </div>
					   <div class="form-group">
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-3">
					      <input type="text" class="form-control" name="validateCode" id="inputPassword3" placeholder="请输入验证码">
					    </div>
					    <div class="col-sm-3">
					   ...
					   <div class="form-group">
					    <div class="col-sm-offset-2 col-sm-10">
					      <div class="checkbox">
					        <label>
						      <input type="checkbox" name="isAutoLogin" value="1" ${empty cookie.isAutoLogin.value?"":"checked='true'"}/> 自动登录
					        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					        <label>
					          <input type="checkbox" name="isRemName" value="1" ${not empty cookie.usernameCookie.value?"checked='true'":""}/> 记住用户名
					        </label>
					      </div>
					    </div>
					  </div>
