...
<html>
	...
	<body>
			...
			<div class="row" style="margin:0 auto;">
				...
				<c:forEach items="${page.data}" var="p">
					<div class="col-md-2" style="text-align:center;margin-top:10px">
						<a href="${pageContext.request.contextPath}/productServlet?method=get&pid=${p.pid}">
							<img src="${p.pimage}" width="170" height="170" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath}/productServlet?method=get&pid=${p.pid}" style='color:green'>${p.pname}</a></p>
			...
			<div style="width:380px;margin:0 auto;margin-top:50px;">
				<ul class="pagination" style="text-align:center; margin-top:10px;">
					<c:if test="${page.page!=1}">
						<li>
							<a href="${pageContext.request.contextPath}/productServlet?method=pageProduct&cid=${cid}&page=${page.page-1}" aria-label="Previous">
					...
					<c:forEach begin="${page.page}" end="${page.page+5}" var="i">
							<c:if test="${i==page.page}">
								<li class="active, disabled">
									<a href="${pageContext.request.contextPath}/productServlet?method=pageProduct&cid=${cid}&page=${i}">${i}</a>
								</li>
							</c:if>
					...
					<c:if test="${page.page!=page.totalPage}">
						<li>
							<a href="${pageContext.request.contextPath}/productServlet?method=pageProduct&cid=${cid}&page=${page.page+1}" aria-label="Next">
        ...
        -->
        <div class="container">
			<div style="width:100%;margin:0 auto; padding: 0 9px;border: 1px solid #ddd;border-top: 2px solid #999;height: 246px;">
	
				<h4 style="width: 50%;float: left;font: 14px/30px " 微软雅黑 ";">浏览记录</h4>
				<div style="width: 50%;float: right;text-align: right;"><a href="">more</a></div>
				<div style="clear: both;"></div>
	
				<div style="overflow: hidden;" id="productHistory">
...
<script type="application/javascript">
	$(function(){
		$.ajax({
			...
			method:"POST",
			data:"method=doProductHistory",
			dataType:"json",
			success:function(data){
				$.each(data,function(i,e){
					var html = "<ul style='list-style: none;'>"
									+"<li style='width: 150px;height: 216;float: left;margin: 0 8px 0 0;padding: 0 18px 15px;text-align: center'>"
									+"	<img src='${pageContext.request.contextPath}/"+e.pimage+"' width='130px' height='130px'/>"
									+"	<p style='color:green;margin-top:10px'>"+e.pname+"</a></p>"
									+"</li>";
									+"</ul>";
					$("#productHistory").append(html);
				});
			}
		});
	});
