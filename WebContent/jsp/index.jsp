				...
				<div class="col-md-10">
					<div class="col-md-6" style="text-align:center;height:200px;padding:0px;">
						<a href="product_info.htm">
							<img src="${pageContext.request.contextPath}/products/hao/middle01.jpg" width="460px" height="200px" style="display: inline-block;">
						</a>
					</div>
					<!--遍历-->
					<c:forEach items="${hotProducts}" var="hotProduct">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath}/productServlet?method=get&pid=${hotProduct.pid}">
								<img src="${hotProduct.pimage}" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath}/productServlet?method=get&pid=${hotProduct.pid}" style='color:#666'>${hotProduct.pname}</a></p>
			...
			<div class="container">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newProducts}" var="newProduct">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath}/productServlet?method=get&pid=${newProduct.pid}">
								<img src="${newProduct.pimage}" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath}/productServlet?method=get&pid=${newProduct.pid}" style='color:#666'>${newProduct.pname}</a></p>
