...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<div>
				<hr/>
				<form class="form-horizontal" style="margin-top:5px;margin-left:150px;" id="orderForm" action="${pageContext.request.contextPath}/orderServlet?method=updateOrder" method="POST">
